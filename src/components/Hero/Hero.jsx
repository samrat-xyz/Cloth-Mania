...
function Hero() {
  return (
    ...
    >
      ...
      <div className="hero-content text-neutral-content text-left relative z-10 max-w-2xl px-6">
        <div className="text-white">
          <p className="text-lg tracking-widest text-primary font-semibold uppercase">
            Cloth Mania
          </p>

          <h1 className="mt-2 mb-6 text-5xl md:text-6xl font-extrabold leading-tight">
          ...
          <div className="flex gap-4">
            ...
            <button className="btn btn-outline border-white text-white hover:bg-white hover:text-black px-8 text-lg">
              Explore Collection
            </button>
          </div>
        </div>
